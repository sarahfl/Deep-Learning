...
tf.keras.utils.plot_model(model, show_shapes=True)  # doesn't show anything for some reason
##
...
plt.show()
##
# Fine tune by also training the mobileNet - well at least a few layers
